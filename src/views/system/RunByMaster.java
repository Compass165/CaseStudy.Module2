        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("Mời nhập Pháp danh Đạo sĩ cần tìm: ");
                    String nameTaoist = scanner1.nextLine();
                    Taoist elementName = new TaoistManager().search(taoistList, nameTaoist);
                    System.out.println("Đạo sĩ cần tìm là: " + elementName.toString());
                    System.out.println("Mời nhập lựa chọn: ");
                    break;
                default:
                    System.err.println("[❌] Lựa chọn không tồn tại, mời các hạ nhập lại !!!");
